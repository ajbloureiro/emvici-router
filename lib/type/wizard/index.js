...
/**
 * Factory Constructor
 * @param  {ConstructedRoute} ConstructedRoute [description]
...
/**
 * @property WizardRoute.construct.defaultOptions
 * @type {Object} Default Options object
 * @lends WizardRoute.options
 */
WizardRoute.construct.defaultOptions = {
     ...
     * 	$steps = array(
     * 		'job_application', 
     * 		array (    'degree' => array('college', 'degree_type'),
     *   			   'nodegree' => 'experience'
     *   	),
     *   	'confirm'
     *   );
 ...
 * @instance
 * @method dispatch
 * @return {Promise} The dispatched Promise
 */
WizardRoute.prototype.dispatch = function () {
    ...
    .then(function () { if( this._shouldSkip ) return;
        ...
        if( this.req.method === 'POST' ) {
            ...
            .then(function () {
                ...
                // Change current url and step on path
                this.params.step = this.currentStep.name;
    ...
    .then(function () { if( this._shouldSkip ) return;
        ...
        if( ! this.currentStep ) {
            ...
            debug( "finishing wizard" );

            return (
                this.router.completed ?
                this.router.completed.dispatch( this.req, this.res ) :
                Promise.cast()
            )
            .bind( this )
            .then(function () {
                this.res.redirect( this.router.options.completedUrl );
            });
