...
/**
 * Adds one Route to the Routes variable.
 * @param {Object} options @see methodContruction#options
 */
 ...
 * Wrapper function used to create a default Initialisation of the METHOD functions.
 * @this Router
 * @param {String} method The name of the method to be added.
 * @param {Array} args Array of arguments that is passed on the method call.
 *                     First position should be the url String to be handled
 *                     Second position should be callback functions.
 */
var methodConstruction = function ( method, args ) {
    ...
    /**
     * @property options
     * Default options for the route method functions.
     * @type {Object}
     */
    var options = {
        /**
         * @property url An array of Route URLs.
         * @type {Array}
         */
        url: [ args[0] ],
        /**
         * @property method The method the urls should be executed.
         * @type {String}
         */
        method: method,
        /**
         * @property stack Array of Function Callbacks or just one fnCb.
         * @type {Array|Function}
         */
        stack: [],
    };
...
/**
 * Maps each METHOD (ex. GET,POST,PUT,... ) as an instance method.
 * Makes it possible to do something like:
 * @example
 * ```
 * var router = new Router();
 * router.get('http://static.example.com',function(){
 * 	// Callback function
 * });
 *
 * or
 *
 * router.post('http://static.example.com',function(){
 * 	// Callback function
 * });
 * ```
 */
